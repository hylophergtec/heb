...
explore: td_orden_encabezado_detalle {
  hidden: no
    join: td_orden_encabezado_detalle__detalle {
      view_label: "Td Orden Encabezado Detalle: Detalle"
      sql: LEFT JOIN UNNEST(${td_orden_encabezado_detalle.detalle}) as td_orden_encabezado_detalle__detalle ;;
      relationship: one_to_many
    }
}
view: td_orden_encabezado_detalle {
  sql_table_name: `cdp-certificacion-heb.cleaning.TD_OrdenEncabezado_Detalle` ;;
  ...
  dimension: oen_autorizacion {
    type: string
    sql: ${TABLE}.OEN_Autorizacion ;;
  }
  dimension: oen_catalogo_extendido {
    type: number
    sql: ${TABLE}.OEN_CatalogoExtendido ;;
  }
  dimension: oen_costo_envio {
    type: string
    sql: ${TABLE}.OEN_CostoEnvio ;;
  }
  dimension: oen_cupon {
    type: string
    sql: ${TABLE}.OEN_Cupon ;;
  }
  dimension: oen_estatus {
    type: string
    sql: ${TABLE}.OEN_Estatus ;;
  }
  dimension: oen_fecha_modificacion {
    type: number
    sql: ${TABLE}.OEN_FechaModificacion ;;
  }
  dimension: oen_forma_pago {
    type: string
    sql: ${TABLE}.OEN_FormaPago ;;
  }
  dimension: oen_monto_pagado {
    type: string
    sql: ${TABLE}.OEN_MontoPagado ;;
  }
  dimension: oen_plataforma {
    type: string
    sql: ${TABLE}.OEN_Plataforma ;;
  }
  dimension: oen_promociones {
    type: string
    sql: ${TABLE}.OEN_Promociones ;;
  }
  dimension: oen_seller {
    type: number
    sql: ${TABLE}.OEN_Seller ;;
  }
  dimension: oen_tipo_envio {
    type: string
    sql: ${TABLE}.OEN_TipoEnvio ;;
  }
  dimension: oen_total_entregado {
    type: string
    sql: ${TABLE}.OEN_TotalEntregado ;;
  }
  dimension: oen_total_ordenado {
    type: string
    sql: ${TABLE}.OEN_TotalOrdenado ;;
  }
  dimension: oen_tpo_cfecha_alta {
    type: number
    sql: ${TABLE}.OEN_TPO_CFechaAlta ;;
  }
  dimension: oen_tpo_cfecha_entrega {
    type: number
    sql: ${TABLE}.OEN_TPO_CFechaEntrega ;;
  }
  dimension: order_id {
    type: string
    sql: ${TABLE}.Order_ID ;;
...
view: td_orden_encabezado_detalle__detalle {
  ...
  dimension: csods_order_status_nm {
    type: string
    sql: CSODS_Order_Status_NM ;;
  }
  dimension: csods_payment_method_id {
    type: number
    sql: CSODS_Payment_Method_ID ;;
  }
  ...
  dimension: csods_precio_original {
    type: number
    sql: CSODS_precio_original ;;
  }
  dimension: csods_promotion_amt {
    type: number
    sql: CSODS_Promotion_AMT ;;
  }
  dimension: csods_quantity_picked_qty {
    type: number
    sql: CSODS_Quantity_Picked_QTY ;;
  }
  dimension: csods_quantity_qty {
    type: number
    sql: CSODS_Quantity_QTY ;;
  }
  dimension: csods_sale_amount_amt {
    type: number
    sql: CSODS_Sale_Amount_AMT ;;
  }
  ...
  dimension: csods_shipping_amt {
    type: number
    sql: CSODS_Shipping_AMT ;;
  }
  dimension: csods_shipping_schedule {
    type: string
    sql: CSODS_Shipping_schedule ;;
  }
  dimension: csods_shipping_type_nm {
    type: string
    sql: CSODS_Shipping_Type_NM ;;
  }
  dimension: csods_sku_remplazo {
    type: string
    sql: CSODS_sku_remplazo ;;
  }
  ...
  dimension: csods_transaction_type_id {
    type: number
    sql: CSODS_Transaction_Type_ID ;;
  }
  dimension: csods_unit_measure_id {
    type: string
    sql: CSODS_Unit_Measure_ID ;;
  }
  ...
  dimension: otl_amount_tax_amt {
    type: number
    sql: OTL_AMOUNT_TAX_AMT ;;
  }
  dimension: otl_business_unit_id {
    type: number
    sql: OTL_Business_Unit_ID ;;
  }
  ...
  dimension: otl_quantity_qty {
    type: number
    sql: OTL_QUANTITY_QTY ;;
  }
  dimension_group: otl_sales_date_dt {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: OTL_Sales_Date_DT ;;
  }
  dimension: otl_ticket_id {
    type: number
    sql: OTL_Ticket_ID ;;
  }
  dimension: td_orden_encabezado_detalle__detalle {
    type: string
    hidden: yes
    sql: td_orden_encabezado_detalle__detalle ;;
  }
  ...
  dimension: thvc_customer_detail_id {
    type: number
    sql: THVC_Customer_Detail_ID ;;
  }
  dimension_group: thvc_fecha_proceso {

  type: time
   timeframes: [date,year,month, month_name,quarter,quarter_of_year]
